...
bool TrafficLight::is_red() { return this->red.is_on() && this->yellow.is_off() && this->green.is_off(); }
bool TrafficLight::is_yellow() { return this->red.is_off() && this->yellow.is_on() && this->green.is_off(); }
bool TrafficLight::is_green() { return this->red.is_off() && this->yellow.is_off() && this->green.is_on(); }
...
PedestrianLight::PedestrianLight(uint red_pin, uint green_pin) : red(red_pin), green(green_pin) {}
...
bool PedestrianLight::is_red() { return this->red.is_on() && this->green.is_off(); }
bool PedestrianLight::is_green() { return this->red.is_off() && this->green.is_on(); }
bool PedestrianLight::is_off() { return this->red.is_off() && this->green.is_off(); }
...
PedestrianRequestButtons::PedestrianRequestButtons(uint north, uint east, uint south, uint west)
...
DirectionalLights::DirectionalLights(TrafficLight traffic, PedestrianLight ped1, PedestrianLight ped2)
